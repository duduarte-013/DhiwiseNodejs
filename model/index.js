...
db.ProductImg = require('./ProductImg');
db.ProductCategory = require('./ProductCategory');
...
db.ProductImg.belongsTo(db.user, {
  foreignKey: 'addedBy',
  as: '_addedBy',
  targetKey: 'id' 
});
db.user.hasMany(db.ProductImg, {
  foreignKey: 'addedBy',
  sourceKey: 'id' 
});
db.ProductImg.belongsTo(db.user, {
...
db.user.hasMany(db.ProductCategory, {
  foreignKey: 'addedBy',
  sourceKey: 'id' 
});
db.ProductCategory.belongsTo(db.user, {
